...
const NAV: NavItem[] = [
  ...
  { href: "/admin/estates/seafields/posts", label: "Seafields Blog", group: "Seafields" },
  { href: "/admin/estates/seafields/media", label: "Seafields Media", group: "Seafields" },
  ...
  { href: "/admin/estates/branscombe/posts", label: "Branscombe Blog", group: "Branscombe" },
  { href: "/admin/estates/branscombe/media", label: "Branscombe Media", group: "Branscombe" },
