          ...
          {(["plan", "satellite", "schematic", "drawing"] as const).map((mode) => {
            ...
            return (
              <button
                ...
                className={`font-archivo text-sm px-3.5 py-2.5 min-h-[46px] inline-flex items-center justify-center transition-colors ${
                  isActive
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-3 items-center text-xs font-archivo">
          <div>
            ...
            <select
              ...
              className="border border-black/10 px-2 py-2.5 min-h-[46px] text-sm text-deep-blue bg-white focus:outline-none focus:border-[#00B5AD]"
            >
        ...
        {(["all", "1", "2", "3", "4", "5", "6", "7"] as const).map((key) => {
          ...
          return (
            <button
              ...
              className={`font-archivo text-sm px-3.5 py-2.5 min-h-[46px] inline-flex items-center border-2 transition-colors ${
                isActive
